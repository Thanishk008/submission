...
plt.title("CNN + SMOTE Training Loss")
plt.grid(True)
plt.savefig("results/cnn_smote_training_loss.png", dpi=300, bbox_inches='tight')
plt.show()
...
plt.title("CNN + SMOTE Confusion Matrix")
...
plt.title("CNN + SMOTE ROC Curve")
plt.legend()
plt.savefig("results/cnn_with_smote_roc_curve.png", dpi=300, bbox_inches='tight')
plt.show()